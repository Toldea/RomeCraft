...
public abstract class RomeCraftBlockHalfSlab extends RomeCraftBlock {
	protected final boolean isDoubleSlab;

	public RomeCraftBlockHalfSlab(int par1, boolean par2, Material par3Material) {
	...
	public boolean shouldSideBeRendered(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5) {
		if (this.isDoubleSlab) {
			...
			return flag ? (par5 == 0 ? true : (par5 == 1 && super.shouldSideBeRendered(par1IBlockAccess, par2, par3, par4, par5) ? true
					: !isBlockSingleSlab(par1IBlockAccess.getBlockId(par2, par3, par4)) || (par1IBlockAccess.getBlockMetadata(par2, par3, par4) & 8) == 0))
					: (par5 == 1 ? true : (par5 == 0 && super.shouldSideBeRendered(par1IBlockAccess, par2, par3, par4, par5) ? true
	...
	@SideOnly(Side.CLIENT)
	public abstract boolean isBlockSingleSlab(int blockID);
	 ...
	 */
	public  abstract int idPicked(World par1World, int par2, int par3, int par4);
}