...
public class ModelBloomery extends ModelBase {
	...
	public ModelBloomery() {
		...
		BloomeryBottomLeft = new ModelRenderer(this, 0, 0);
		...
		BloomeryBottomRight = new ModelRenderer(this, 0, 0);
		...
		BloomeryMiddleFront = new ModelRenderer(this, 0, 0);
		...
		BloomeryMiddleBack = new ModelRenderer(this, 0, 0);
		...
		BloomeryMiddleRight = new ModelRenderer(this, 0, 0);
		...
		BloomeryMiddleLeft = new ModelRenderer(this, 0, 0);
		...
		BloomeryTopFront = new ModelRenderer(this, 0, 0);
		...
		BloomeryTopBack = new ModelRenderer(this, 0, 0);
		...
		BloomeryTopLeft = new ModelRenderer(this, 0, 0);
		...
		BloomeryTopRight = new ModelRenderer(this, 0, 0);
