...
public class RenderEntityLegionary extends RenderLiving {
	...
	protected ModelLegionaryBiped field_82425_h;
	...
	public RenderEntityLegionary(ModelLegionaryBiped par1ModelBiped, float par2, float par3) {
	...
	protected void func_82421_b() {
		this.field_82423_g = new ModelLegionaryBiped(1.0F);
		this.field_82425_h = new ModelLegionaryBiped(0.5F);
	}
	...
	public static ResourceLocation getArmorResource(Entity entity, ItemStack stack, int slot, String type) {
		...
		String s1 = String.format("textures/models/armor/%s_layer_%d%s.png", bipedArmorFilenamePrefix[item.renderIndex], (slot == 2 ? 2 : 1), type == null ? ""
				: String.format("_%s", type));
	...
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
		...
		this.setAnimationStatus((EntityLegionary)par1EntityLiving, itemstack);
		...
		this.field_82423_g.aimedPilum = this.field_82425_h.aimedPilum = this.modelBipedMain.aimedPilum = false;
	...
	protected void setAnimationStatus(EntityLegionary par1EntityLegionary, ItemStack par2ItemStack) {
		...
		this.field_82423_g.isSneak = this.field_82425_h.isSneak = this.modelBipedMain.isSneak = par1EntityLegionary.isSneaking();
		this.field_82423_g.aimedPilum = this.field_82425_h.aimedPilum = this.modelBipedMain.aimedPilum = par1EntityLegionary.isHoldingPilum();
	}
