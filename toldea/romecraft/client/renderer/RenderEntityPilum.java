...
public class RenderEntityPilum extends Render {
	...
	public void renderArrow(EntityPilum par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
	...
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		...
		//this.renderArrow((EntityPilum) par1Entity, par2, par4, par6, par8, par9);
