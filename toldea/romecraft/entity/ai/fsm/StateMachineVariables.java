...
public abstract class StateMachineVariables {
	// Global State Machine Variables.
	public static String OWNER_ENTITY = "ownerEntity";
	public static String TARGET_LOCATION = "targetLocation";
	public static String TARGET_TILE_ENTITY = "targetTileEntity";
	public static String TARGET_ISIDED_INVENTORY = "targetISidedInventory";
